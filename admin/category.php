...
<body>
    <div class="container-xxxl" style="display:inline-block;max-width:140%;min-width:101%">
        <div class="row">
                ...
                <div class="d-flex flex-column flex-shrink-0 bg-light" style="width:110%; height:150%">
                    ...
                    <div style="margin:1% 0%; padding:0%" class="d-flex flex-column mb-3">
                        ...
                        <div class="p-2" style=" margin:-3% 1%">
                            <div class="fs-4 mb-3">
                                <button style="background: orangered; width:180px; margin:-1%; border-radius:10px; padding:1%">
                        ...
                        <div class="p-2" style=" margin:-5% 0%">
                            <div class="fs-4 mb-3">
                                <a class="aa" href="user.php" style="font: size 12px" class="d-block p-3 link-dark text-decoration-none" title="Icon-only" data-bs-toggle="tooltip" data-bs-placement="right">
            ...
            <div class="col" style="padding:0%">
                ...
                <!--category details display section begins-->
                <div style="margin:6px">
                    <table align="center" bgcolor="white" cellpadding="12px" cellspacing="4px">
                        ...
                        $result = $cn->query("select * from category");
                        ...
                        ?>
                            <tbody>
                                ...
                                <?php echo '<td><button class="btn btn-primary"><a style="color:white; text-decoration:none" href="updateCat.php?updateid=' . $id . '">Modify</a></button>
                                <button class="btn btn-danger"><a style="color:white; text-decoration:none" href="deleteCat.php?did=' . $id . '">Delete</a></button>
                                </th>
                                <td>
                                    <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="updateAct.php?uid=' . $id . '">Active</a></li>
                                        <li><a class="dropdown-item" href="updateNAct.php?uid=' . $id . '">Not active</a></li>
                                    </ul>
                                    </div> </td>
                                </tr>';
                                echo '</tbody>';
                ...
                <a href="addcategory.php">
                    <button style="margin:3% 25%" class="btn btn-primary">Add category</button>
                </a>
            </div>
        </div>
    </div>
