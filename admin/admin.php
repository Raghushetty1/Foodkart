            ...
            <div class="row">
                <div class="col-3 bg-light" style="padding:0% 2%">
                    <div class="d-flex flex-column flex-shrink-0 bg-light" style="width:110%; height:150%">
                        <a href="../admin/adminModify.php"  style="text-decoration:none"></a:href><h1 style="color:black;font-weight:bold; margin:8% 0%">
...
<?php
    ...
    echo "<script>alert('Only admin can only access this page');</script>";
