...
<body>
    <div class="container-xxxl" style="display:inline-block;max-width:130%;min-width:110%">
        <div class="row">
                ...
                <div class="d-flex flex-column flex-shrink-0 bg-light" style="width:110%; height:150%">
                    ...
                    <div style="margin:1% 0%; padding:0%" class="d-flex flex-column mb-3">
                        ...
                        <div class="p-2" style="padding:0%">
                            <div class="fs-4 mb-3">
                                <button style="background: orangered; width:120px; margin:-1%; border-radius:10px; padding:1%">
            ...
            <div class="col" style="padding:0%">
                ...
                <!--order details display section begins-->
                <div style="margin:6px">
                    <table align="center" bgcolor="white" cellpadding="12px" cellspacing="4px">
                        ...
                        $result = $cn->query("SELECT * FROM `order1`");
                        ...
                        ?>
                            <tbody>
                                <tr>
                                    <td><?php echo $i; ?></td>
                                    <td><?php echo $r['uid1']; ?></td>
                                    <td><?php echo $r['orderid']; ?></td>
                                    <td><?php echo $r['iid']; ?></td>
                                    <td><?php
                                        //$con=mysqli_connect('localhost','root','','foodkart');
                                        $rslt = $cn->query("SELECT  * FROM `item` WHERE iid='" . $id . "'");
                                        while ($rs = $rslt->fetch_assoc()) {
                                            echo $rs['iname'];
                                            echo '</td>';
                                            echo '<td>';
                                        ?>
                                            <?php echo '<img src="../images/' . $rs['img'] . '" width="100" height="110"/>'; ?>
                                    ...
                                    <td><?php echo $r['st']; ?></td>
                                    <td><?php $qry1 = "select max(grandtotal) as gt from order1";
                                        $rslt = $cn->query($qry1);
                                ...
                                <?php echo '<td>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="updateStP.php?uid=' . $uid1 . '">Prepared</a></li>
                                        <li><a class="dropdown-item" href="updateStN.php?uid=' . $uid1 . '">Not prepared</a></li>
                                    </ul>
                                    </div> </td>';
                                echo '</tr>';
                                echo '</tbody>';
