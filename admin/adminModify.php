            ...
            <div class="col-3 bg-light" style="padding:0% 2%">
                <div class="d-flex flex-column flex-shrink-0 bg-light" style="width:110%; height:150%">
                    ...
                    <div style="margin:1% 0%; padding:0%" class="d-flex flex-column mb-3">
                        <div class="p-2">
                            <a href="admin.php" class="d-block p-3 link-dark text-decoration-none" title="Icon-only"
                        ...
                        <div class="p-2" style="padding:0%">
                            <div class="fs-4 mb-3">
                                <a class="aa" href="status.php" style="font: size 12px"
                        ...
                        <div class="p-2" style=" margin:-5% 1%">
                            <div class="fs-4 mb-3">
                                ...
                                <a class="aa" href="staff.php" style="font: size 12px"
                                    class="d-block p-3 link-dark text-decoration-none" title="Icon-only"
                                    data-bs-toggle="tooltip" data-bs-placement="right">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor"
                        ...
                        <div class="p-2" style=" margin:-3% 1%">
                            <div class="fs-4 mb-3">
                                <a class="aa" href="category.php" style="font: size 12px"
                                    class="d-block p-3 link-dark text-decoration-none" title="Icon-only"
                                    data-bs-toggle="tooltip" data-bs-placement="right">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <div class="p-2" style="margin:-3% 0%">
                            <a class="aa" href="item.php" style="font: size 12px"
                                class="d-block p-3 link-dark text-decoration-none" title="Icon-only"
                                data-bs-toggle="tooltip" data-bs-placement="right">
                        ...
                        <div class="p-2" style="margin:1% 0%">
                            <a class="aa" href="order.php" style="font: size 12px"
                                class="d-block p-3 link-dark text-decoration-none" title="Icon-only"
                                data-bs-toggle="tooltip" data-bs-placement="right">
                                <div class="fs-4 mb-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <table align="center" bgcolor="white" cellpadding="12px" cellspacing="4px">
                        ...
                        <?php
                            ...
                            while($r=$result->fetch_assoc())
                            {
                                ...
                                <th><a style="color:white; text-decoration:none" href="updateAdmin.php?update1='.$id.'"><button class="btn btn-primary">Modify</button></a>
