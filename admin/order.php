                ...
                <div class="d-flex flex-column flex-shrink-0 bg-light" style="width:110%; height:150%">
                    ...
                    <div style="margin:1% 0%; padding:0%" class="d-flex flex-column mb-3">
                        ...
                        <div class="p-2" style="margin:1% 0%">
                            <button style="background: orangered; width:140px; height:45px; margin:-1%; border-radius:10px; padding:0% 1%">
            ...
            <div class="col" style="padding:0%">
                ...
                <div style="padding:0%">
                    <table align="center" bgcolor="white" cellpadding="12px" cellspacing="4px">
                        ...
                        $result = $cn->query("SELECT * FROM `order1` WHERE st='Not prepared'");
                ...
                <a href="status.php">
                    <button style="margin:3% 8%" class="btn btn-primary">Update order status</button>
                </a>
            </div>
        </div>
    </div>
