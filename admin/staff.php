    ...
    <div class="container-xxxl" style="display:inline-block;max-width:135%;min-width:101%">
        <div class="row">
            ...
            <div class="col" style="margin:-1% 0%; padding:1% 0%">
                    ...
                    <table align="center" bgcolor="white" cellpadding="12px" cellspacing="4px">
                        ...
                        while ($r = $result->fetch_assoc()) {
                            ...
                            echo '<tr>
                                ...
                                <th>' . $r['address'] . '</th>
                                <th>' . $r['salary'] . '</th>
                                <th><button class="btn btn-primary"><a style="color:white; text-decoration:none" href="updateEmp.php?updateid=' . $id . '">Modify</a></button> 
                                <button class="btn btn-danger"><a style="color:white; text-decoration:none" href="deleteEmp.php?did=' . $id . '">Delete</a></button>
                                </th></tr>';
                        }
                        $con->close();
                        ?>
                ...
                <a href="addemp.php">
                    <button style="margin:3% 10%" class="btn btn-primary">Add employee</button>
                </a>
            </div>
        </div>
    </div>
