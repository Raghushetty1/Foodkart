...
<body>
    <div class="container-xxxl" style="display:inline-block;max-width:135%;min-width:101%">
        <div class="row">
                ...
                <div class="d-flex flex-column flex-shrink-0 bg-light" style="width:110%; height:150%">
                    ...
                    <div style="margin:1% 0%; padding:0%" class="d-flex flex-column mb-3">
                        ...
                        <div class="p-2" style="margin:-3% 0%">
                            <button style="background: orangered; width:160px; margin:-1%; border-radius:10px; padding:1%">
            ...
            <div class="col" style="padding:0%">
                ...
                <!--item details display section begins-->
                <div style="margin:6px">
                    <table align="center" bgcolor="white" cellpadding="12px" cellspacing="4px">
                        ...
                        $result = $cn->query("select * from item");
                        ...
                        ?>
                            <tbody>
                                <tr>
                                    ...
                                    <td><?php
                                        $rslt = $cn->query("SELECT  * FROM `category` WHERE cat_id='" . $cid1 . "'");
                                        while ($rs = $rslt->fetch_assoc()) {
                                            echo $rs['cname'];
                                        }
                                        ?>
                                        <?php echo '</td>'; ?>
                                    <td><?php echo $r['iid']; ?></td>
                                ...
                                <?php echo '<td><a style="color:white; text-decoration:none" href="updateItem.php?updateid=' . $id . '"><button class="btn btn-primary">Modify</button></a><br>
                                <a style="color:white; text-decoration:none" href="deleteItem.php?did=' . $id . '"><button class="btn btn-danger" style="margin:3px">Delete</button></a>
                                </th>
                                <td>
                                    <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="updateSpcl.php?uid=' . $id . '">Active</a></li>
                                        <li><a class="dropdown-item" href="updateNSpcl.php?uid=' . $id . '">Not active</a></li>
                                    </ul>
                                    </div> </td>
                                </tr>';
                                echo '</tbody>';
                ...
                <a href="additem.php">
                    <button style="margin:3% 25%" class="btn btn-primary">Add Item</button>
                </a>
            </div>
        </div>
    </div>
