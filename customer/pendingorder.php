            ...
            <div class="container h-100 py-5">
                <div class="row d-flex justify-content-center align-items-center h-100">
                    <div class="col-10">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h3 class="fw-normal mb-0 text-black">Pending orders</h3>
                            <div>
                        ...
                        $qry = "select * from order1 where st='Not prepared' and uid1='".$user1."'";
                        $rslt = $cn->query($qry);
                ...
                src="../images/' . $r1['img'] . '" class="img-fluid rounded-3" alt="image1">';
                                        ...
                                        <div class="col-md-1 col-lg-1 col-xl-1 text-end">
                                            <a href="../customer/cancelorder.php?did=<?php echo $iid ?>" class="text-danger" data-toggle="tooltip" data-placement="top" title="Cancel order"><i class="fas fa-trash fa-lg"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
