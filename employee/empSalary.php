    ...
    <div class="container-xxxl">
        <div class="row">
            <div class="col-3 bg-light" >
                <div class="d-flex flex-column flex-shrink-0 bg-light" style="padding:0% 2%; width:110%; height:200%">
            ...
            <div class="col" style="padding:0% 1.3%">
                ...
                <div style="margin:6px">
                    <table align="center" bgcolor="white" cellpadding="12px" cellspacing="4px">
                        ...
                        <?php
                            ...
                            //$qry="select * from emp where user='".$empid1."'";
                            //select * from emp where user ='dhanush';
                            $qry ="select * from emp where user ='$empid1'";
                            // echo $qry;
                            $result=$cn->query($qry);
                            ...
                            { 
                                ...
                                <!--calculating da of customer using basic salary in employee table-->
                                <td><?php if($basic<20000)
                                        {
                                            $da=$basic*0.4;
                                            $hra=$basic*0.15;
                                            $tax=100;
