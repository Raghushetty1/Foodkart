...
<body style="background-color: rgb(231, 228, 223)">
    <form style="float:left; margin:5%; padding:4%; border:2px solid black; border-radius: 15px" action="a.php" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="file"  accept="image/png, image/jpeg" required name="image" class="form-control" id="image">
        </div>
...
if (isset($_POST['submit'])) {
   ...
   echo $img;
    ...
    if ($rslt->num_rows != 0) {
        ...
        $qry = "INSERT INTO category (cat_id,cname,img) VALUES (" . $cat_id1 . ",'" . $cname1 . "','" . $img . "')";
        $rslt = $cn->query($qry);
        if ($rslt) {
